...
//            long ageOfRecordInMillis = System.currentTimeMillis() - recordCreateTime;
            ...
            LOG.info(record.getSequenceNumber() + ", " + record.getPartitionKey() + ", " + data + ", Message Count"
                    );
            int c = a.incrementAndGet();
            System.out.println(record.getSequenceNumber() + ", " + record.getPartitionKey() + ", " + data + ", Message Count: " + String.valueOf(c)
            );
